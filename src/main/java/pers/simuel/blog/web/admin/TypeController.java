...
public class TypeController {
    ...
    private final String TYPE_INPUT_URL = "admin/types-input";

    private final String TYPE_REDIRECT_URL = "redirect:/admin/types";
